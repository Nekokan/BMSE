        ...
        With g_Obj(num)
            ...
            If optProcessReplace.Checked Then
                ...
                If .intCh <> 8 And .intCh <> 9 Then
                    ...
                    m_strArray(UBound(m_strArray)) = modInput.strFromNum(modLog.CMD_LOG.OBJ_CHANGE) & modInput.strFromNum(.lngID, 4) & modInput.strFromNum(.sngValue) & VB.Right("0" & txtReplace.Text, 2)
